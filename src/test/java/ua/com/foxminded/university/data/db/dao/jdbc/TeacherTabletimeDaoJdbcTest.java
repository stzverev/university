...
class TeacherTabletimeDaoJdbcTest {

    private TeacherTabletimeDaoJdbc teacherTabletimeDaoJdbc;
    ...
    private void init() {
        ...
        teacherTabletimeDaoJdbc =
                context.getBean(TeacherTabletimeDaoJdbc.class);
    ...
    void shouldGetTabletimeForTeacherWhenSaveTabletimeThenOk() {
        ...
        teacherTabletimeDaoJdbc.saveTabletime(tabletime);
        ...
        Tabletime tabletimeGet = teacherTabletimeDaoJdbc.getTabletime(teacher,
                begin, end);
