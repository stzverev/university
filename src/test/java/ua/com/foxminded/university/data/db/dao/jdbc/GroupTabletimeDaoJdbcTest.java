...
class GroupTabletimeDaoJdbcTest {

    private GroupTabletimeDaoJdbc groupTabletimeDaoJdbc;
    ...
    private void init() {
        ...
        groupTabletimeDaoJdbc =
                context.getBean(GroupTabletimeDaoJdbc.class);
    ...
    void shouldGetTabletimeForCourseWhenSaveTabletimeThenOk() {
        ...
        groupTabletimeDaoJdbc.saveTabletime(tabletime);
        ...
        Tabletime tabletimeGet = groupTabletimeDaoJdbc.getTabletime(group,
                begin, end);
